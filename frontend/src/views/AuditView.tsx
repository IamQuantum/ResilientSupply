      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-semibold transition-colors shadow-xs"
          >
                  ...
                  <tr key={idx} className="hover:bg-slate-50/70 transition-colors font-mono">
                    ...
                    <td className="py-3.5 px-5 font-sans">
                      {isRejected ? (
                        ...
                        <span className="inline-flex items-center gap-1.5 text-slate-700 bg-slate-100 border border-slate-200 px-2 py-0.5 rounded-full font-semibold text-[11px]">
